...
import static himedia.java.member_t.A_PricePlan.*;
...
public class A_managementImpl implements A_member{
    ...
    public void printPricePlan() {
        ...
        System.out.println("[1] Lite : 10명 [2] Basic : 20명 [3] Premium : 30명 [4] Free : 무제한");
    ...
    public void addMember() {
        ...
        if(totalCnt!= -1 && currentMemberCnt>=totalCnt){
            System.out.println("인원이 꽉 찼습니다. 다른 요금제를 선택해주세요");
            return;
        }
    ...
    public void updatePricePlan(int planNum) {
        ...
        if(
                type!=null && type !=FREE&&memberMap.size() >=type.getCount()
        ){
            if(pricePlan==type){
